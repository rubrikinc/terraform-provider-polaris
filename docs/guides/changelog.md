...
## v1.6.0
* Migrate the `polaris_custom_role` and `polaris_role_assignment` resources and the `polaris_role` and
  `polaris_role_template` data sources to the Terraform Plugin Framework.
