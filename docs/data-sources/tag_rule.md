...
- `tag_all_values` (Boolean, Deprecated) **Deprecated:** Use `tag` instead. If true, all tag values are matched.
- `tag_key` (String, Deprecated) **Deprecated:** Use `tag` instead. Tag key to match.
- `tag_value` (String, Deprecated) **Deprecated:** Use `tag` instead. Tag value to match. If the tag value is empty, it matches empty values.
